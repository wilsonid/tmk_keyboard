...
#define KEYMAP( \
    ...
    K40,      K42, K43,           K46,           K49, K4A, K4B, K4C, K4D, K4E  \
) { \
   ...
   { KC_##K30, KC_NO,    KC_##K32, KC_##K33, KC_##K34, KC_##K35, KC_##K36, KC_##K37, KC_##K38, KC_##K39, KC_##K3A, KC_##K3B, KC_##K3C, KC_##K3D, KC_##K3E}, \
   { KC_##K40, KC_NO,    KC_##K42, KC_##K43, KC_NO,    KC_NO,    KC_##K46, KC_NO,    KC_NO,    KC_##K49, KC_##K4A, KC_##K4B, KC_##K4C, KC_##K4D, KC_##K4E}  \
}
#endif
